...
function [retcode, ax, af, ag, alpha] = linesearch(n, x, f, g, d, initalpha, prob);
...
[retcode, ax, af, ag, alpha] = bracketing(n, x, f, g, d, initalpha, prob, sigma, rho, tau1, tau2, tau3, lowerbd);
