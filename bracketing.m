...
function [retcode, ax, af, ag, alpha] = bracketing(fn, grad, n, x, f, g, d, initalpha, prob, sigma, rho, tau1, tau2, tau3, lowerbd);
...
while k < 20;
  ...
  if f_alpha > f_zero + alpha*rho*df_zero | f_alpha >= f_alpha_prev;
    ...
    [retcode, ax, af, ag, alpha] = sectioning(fn,grad, n, x, ax, g, ag, d, alpha, prob, rho, tau2, tau3, sigma, a, b, f_zero, df_zero, f_a, f_b, df_a, 0);
    return;
  end;
